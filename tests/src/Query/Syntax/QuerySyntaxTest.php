...
class QuerySyntaxTest extends QueryTestCase
{
    ...
    public function test_where_raw(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" WHERE id1 = id2', $q->toString());
    }
    ...
    public function test_where_eq_null(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" WHERE "id" IS NULL', $q->toString());
    }
    ...
    public function test_where_ne_null(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" WHERE "id" IS NOT NULL', $q->toString());
    }
    ...
    public function test_where_like(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" WHERE "name" LIKE \'a%\'', $q->toString());
    }
    ...
    public function test_where_not_exists(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" WHERE NOT EXISTS (SELECT * FROM "t2" WHERE "id" = 1)', $q->toString());
    }
    ...
    public function test_groupBy_single_column(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" GROUP BY "id"', $q->toString());
    }
    ...
    public function test_groupBy_multiple_column(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" GROUP BY "id", "name"', $q->toString());
    }
    ...
    public function test_having(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" GROUP BY "id" HAVING "id" = 1', $q->toString());
    }
    ...
    public function test_orderBy_single_column(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" ORDER BY "id"', $q->toString());
    }
    ...
    public function test_orderBy_single_column_desc(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" ORDER BY "id" DESC', $q->toString());
    }
    ...
    public function test_orderBy_multiple_column(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" ORDER BY "id", "name" DESC', $q->toString());
    }
    ...
    public function test_orderBy_null_last(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" ORDER BY "id" NULLS LAST', $q->toString());
    }
    ...
    public function test_orderBy_full_spec(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" ORDER BY "id" DESC NULLS LAST', $q->toString());
    }
    ...
    public function test_limit(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" LIMIT 10', $q->toString());
    }
    ...
    public function test_offset(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" OFFSET 10', $q->toString());
    }
    ...
    public function test_limit_and_offset(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" LIMIT 10 OFFSET 10', $q->toString());
    }
    ...
    public function test_returning_no_column(): void
    {
        ...
        $this->assertSame('INSERT INTO "t" ("id", "name") VALUES (1, \'a\') RETURNING *', $q->toString());
    }
    ...
    public function test_returning_single_column(): void
    {
        ...
        $this->assertSame('INSERT INTO "t" ("id", "name") VALUES (1, \'a\') RETURNING "id"', $q->toString());
    }
    ...
    public function test_returning_multiple_column(): void
    {
        ...
        $this->assertSame('INSERT INTO "t" ("id", "name") VALUES (1, \'a\') RETURNING "id", "name"', $q->toString());
    }
    ...
    public function test_asTable_basic(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t"', $q->toString());
    }
    ...
    public function test_asTable_with_alias(): void
    {
        ...
        $this->assertSame('SELECT * FROM "t" AS "a"', $q->toString());
    }
    ...
    public function test_asTable_with_database(): void
    {
        ...
        $this->assertSame('SELECT * FROM "db"."t"', $q->toString());
    }
    ...
    public function test_asTable_with_alias_and_database(): void
    {
        ...
        $this->assertSame('SELECT * FROM "db"."t" AS "a"', $q->toString());
    }
}
